...
<div class="container">
    ...
    <form action="{{ route('mitra.update', $mitra->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="user_name" name="user_name" value="{{ old('user_name', $mitra->user->name) }}" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="harga_sewa" name="harga_sewa" value="{{ $mitra->harga_sewa }}" required>
        </div>
